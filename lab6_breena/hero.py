...
class Hero:
    ...
    def __init__(self, name, starting_health=100): # starting_health=100 makes the starting_health argument OPTIONAL
        self.name = name
    ...
    def attack(self):
        ...
        for ability in self.abilities:
            total_damage += ability.attack() # total_damage = total_damage + ability_attack()
        print(total_damage)
        return total_damage

    def add_armor(self, armor): # adds an armor to hero's list of armors
...
if __name__ == "__main__":
    my_hero = Hero("Spider-Man", 150) # 150 is starting health
    print(my_hero.name)
